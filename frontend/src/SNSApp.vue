    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                key: 'lossManagements', 
                route: '/losses/lossManagements',
                ImageUrl: '',
            },
            { 
                title: 'UserManagement', 
                description: 'UserManagement을 관리하는 화면입니다.', 
                key: 'userManagements', 
                route: '/users/userManagements',
                ImageUrl: '',
            },
            { 
                title: 'ReportManagement', 
                description: 'ReportManagement을 관리하는 화면입니다.', 
                key: 'reportManagements', 
                route: '/reports/reportManagements',
                ImageUrl: '',
            },
            { 
