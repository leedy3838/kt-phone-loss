...
pluralCaseList.push( {plural: "phones/phoneManagements", pascal: "PhonePhoneManagement"} )

pluralCaseList.push( {plural: "losses/lossManagements", pascal: "LossLossManagement"} )


pluralCaseList.push( {plural: "users/userManagements", pascal: "UserUserManagement"} )

pluralCaseList.push( {plural: "reports/reportManagements", pascal: "ReportReportManagement"} )

pluralCaseList.push( {plural: "rentals/rentalManagements", pascal: "RentalRentalManagement"} )
